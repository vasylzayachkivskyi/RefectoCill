$(function () {
  ...
  $(".sale__slider").slick({
    ...
    dots: true,
    prevArrow:
      '<button type="button" class="slider_btn slider_prev"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.89958 21.7989L18.7991 11.8994L8.89958 1.99992" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button>',
    nextArrow:
      '<button type="button" class="slider_btn slider_next"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.89958 21.7989L18.7991 11.8994L8.89958 1.99992" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></button>',
    responsive: [
      {
        breakpoint: 1500,
        settings: {
